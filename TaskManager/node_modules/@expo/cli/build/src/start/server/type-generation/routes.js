...
_export(exports, {
<<<<<<< HEAD
    ARRAY_GROUP_REGEX: function() {
        return ARRAY_GROUP_REGEX;
    },
    CAPTURE_DYNAMIC_PARAMS: function() {
        return CAPTURE_DYNAMIC_PARAMS;
    },
    CAPTURE_GROUP_REGEX: function() {
...
=======
    CAPTURE_DYNAMIC_PARAMS: ()=>CAPTURE_DYNAMIC_PARAMS,
    CATCH_ALL: ()=>CATCH_ALL,
    SLUG: ()=>SLUG,
    ARRAY_GROUP_REGEX: ()=>ARRAY_GROUP_REGEX,
    CAPTURE_GROUP_REGEX: ()=>CAPTURE_GROUP_REGEX,
    TYPED_ROUTES_EXCLUSION_REGEX: ()=>TYPED_ROUTES_EXCLUSION_REGEX,
    setupTypedRoutes: ()=>setupTypedRoutes,
    getTemplateString: ()=>getTemplateString,
    getTypedRoutesUtils: ()=>getTypedRoutesUtils,
    setToUnionType: ()=>setToUnionType,
    extrapolateGroupRoutes: ()=>extrapolateGroupRoutes
});
function _promises() {
...
=======
                ...
                let set1 = staticRoutes.get(originalRoute);
                if (!set1) {
                    set1 = new Set();
                    staticRoutes.set(originalRoute, set1);
                }
                set1.add(route);
>>>>>>> 0823204efb84884a0322b43e865bb36631ba8251
            }

...
Современное мобильное приложение для управления задачами, разработанное с использованием **React Native**, **Expo** и **React Navigation**. Проект содержит две адаптированные версии: для iOS (рекомендуется iOS 16+) и для Android (актуальная версия системы). Конфигурация подбирается автоматически, так что приложение выглядит нативно на каждой платформе.
...
- 🌓 **Светлая и тёмная тема** - автоматическое и ручное переключение
- 📱 **Адаптивный дизайн** - оптимизировано для всех размеров экранов
- 🎨 **Платформенные цвета** - по умолчанию разные акценты для iOS и Android
...
- 🗓️ **Мини-календарь месяца** - быстрый выбор нужного месяца
- 🗂️ **Группировка по статусу** на месячном экране
- 📄 **Экспорт задач** месяца в PDF/Excel
- ⚡ **Быстрое добавление задач** прямо из просмотра месяца
